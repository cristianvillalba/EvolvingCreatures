...
public class MJNeuron implements Savable {
    ...
    private float torqueforceratio = 600f;
        ...
        else
        {
            ...
            for (int j = 0 ; j < weights.size(); j++)
            {
                if (FastMath.nextRandomFloat() < mutationrate){
                    ...
                    //float r = nweig.get(j) * FastMath.nextRandomFloat()*0.001f - 0.0005f;
                    //float r = nweig.get(j) * FastMath.nextRandomFloat()*0.0001f - 0.00005f;
                    //System.out.println("Weight original: " + nweig.get(j));
                    float r = nweig.get(j) * (1.0f + FastMath.nextRandomFloat()*randvalue - randvalue/2);
                    //System.out.println("Weight mutated: " + r);
                    //nweig.set(j, FastMath.nextRandomFloat());   
                    nweig.set(j, r);   
                }
            }
            ...
            //if (FastMath.nextRandomFloat() < mutationrate){
            //    float newtorqueforceratio = torqueforceratio  * (1.0f + FastMath.nextRandomFloat()*0.1f - 0.1f/2);
            ...
            //if (FastMath.nextRandomFloat() < mutationrate){
           //     torqueclone.set(FastMath.nextRandomFloat()*0.3f - 0.15f,FastMath.nextRandomFloat()*0.3f - 0.15f, FastMath.nextRandomFloat()*0.3f - 0.15f).normalizeLocal();
          //  }
            ...
            //if (FastMath.nextRandomFloat() < mutationrate){
            //    float newbias = bias * (1.0f + FastMath.nextRandomFloat()*randvalue - randvalue/2);
                ...
                if (inputs.size() > 0) {
                    ...
                    switch(effectortype)
                    {
                        ...
                        {            
                                ...
                                //finalvalue = FastMath.clamp(finalvalue, -15f, 15f);
                                //System.out.println(finalvalue);
