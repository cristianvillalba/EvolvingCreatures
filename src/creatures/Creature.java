...
public class Creature implements Comparable, Savable{
    ...
    public void Tick(float tpf)
    {
        ...
        if (neuronmain != null && neuronmain.size() > 0){
            ...
            for (int i =0 ; i < neuronmain.get(2).length - 1; i++)
            {
                ...
                neuronmain.get(2)[i].fire(tpf, maxtick);
            }
        }
    ...
    public void CopyBrain(HashMap<MJNode, MJNode> sbrainnodes, boolean mutate, Creature father)
    {
        ...
        MJNeuron[] effectors = new MJNeuron[father.GetBrain().get(2).length];
        ...
        for (int i = 0; i < father.GetBrain().get(2).length; i++)
        {
            ...
            MJNode part = father.GetBrain().get(2)[i].GetPart();
            mirror.SetPart(sbrainnodes.get(part));
    ...
    public void PrintBrain(ArrayList<MJNeuron[]> b)
    {
        ...
        for(int i = 0; i < b.get(3).length; i++)
        {
            System.out.println(b.get(3)[i].GetInfo());
        }
    }
    ...
    public void GenerateBrain()
    {
        ...
        //int randneuronsizev0 = FastMath.nextRandomInt(20, 30);
        int randneuronsizev0 = 10;
        MJNeuron[] neuronsv0 = new MJNeuron[randneuronsizev0];
        
        //int randneuronsize = FastMath.nextRandomInt(20, 30);
        ...
        for(int i = 0; i < effectors.length; i++)
        {
            ...
            MJNeuron eff = new MJNeuron(0.05f, 2, i % 6);
            eff.SetPart(part);
            effectors[i] = eff;
